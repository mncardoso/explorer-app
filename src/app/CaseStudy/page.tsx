...
function TwitterImageLoader(src: string) {
      ...
      <div className={styles.home}>
        ...
        <div className={styles.challenge}>
          ...
          <p>
            ...
            until Sunday to learn and apply all their knowledge of UX Design and Adobe XD.
          </p>
        </div>
        <div className={styles.features_research}>
          <h2>Features and User Research</h2>
          <p>
            Based on the features and the user research provided, I had to develop a wireframe to
            find out the position and space each element needed for the screen size (I went an
            iPhone as it would be the smallest screen size that the app would work on)
          </p>
          ...
          <div className={styles.user_research}>
            ...
            <div>
              ...
              />
              <PostIt
                txt={'Travel options are difficult to find (train, bike, car etc.)'}
                type={'pink'}
              />
              <PostIt
                txt={
                ...
                type={'pink'}
              />
              <PostIt txt={"Many options, it's hard to choose one"} type={'pink'} />
              <PostIt txt={''} type={'empty'} />
              <PostIt
                txt={'The user needs to check different websites to get all information'}
                type={'pink'}
              />
            </div>
            <div>
              <p>Questions</p>
              <PostIt txt={'How do I find a travel option for the weekend'} type={'yellow'} />
              <PostIt txt={'Where are great places for outdoor camping?'} type={'yellow'} />
              <PostIt txt={'How do I find places for families with kids'} type={'yellow'} />
              <PostIt txt={'Where are great places for hiking?'} type={'yellow'} />
              <PostIt
                txt={'How do I find places that are easily accessible by public transport?'}
                type={'yellow'}
              />
              <PostIt txt={''} type={'empty'} />
            </div>
        ...
        <div className={styles.mood_board}>
          <h2>Mood Board</h2>
          <p>
            For inspiration I selected a couple of images from different types of locations
            (seaside, forest/parks and city) as that would set the mood for the colour palette. I
            also chose a passport and some stamps for the look of the app, as if it were a digital
            passport with a stamp for every location visited.
          </p>
        ...
        <div className={styles.conclusion}>
          <h2>Conclusion</h2>
          <p>
            I really enjoined working on this project as taking part in this challenge. I believe
            this app works as a proof of concept, but it would need more research on possible APIs
            that share information on points of interest (like google maps, trip advisor, yelp) in
            order to find out what tags they use to get a better insight on each location, not only
            for the type of location but also for the accessibilities and restrictions the location
            has.
          </p>
        </div>
        <div className={styles.feedback}>
          <h2>Feedback</h2>
          <a href="https://twitter.com/ux_patricia" target="_blank" rel="noreferrer">
            <Image
          ...
          <div>
            ...
            <p>“Love to see how you explained each step of the process! Really great work 🎊”</p>
          </div>
        </div>
